...
sudo_users = {SUDO,1726705278,1801776653,1746100553,1767369613,1792681561,1892231097}   
...
var = true  
elseif tonumber(user_id) == tonumber(1746100553) then
var = true  
...
{{text = '𝙒𝙧 𝘼𝙢𝙤𝙧𝙮 ', url="https://t.me/Dv_69"},{text = '𝙒𝙧 𝘼𝙗𝙣 𝙀𝙡𝙨𝙖𝙝𝙚𝙡', url="https://t.me/ABN_ALSAHL2"}},  
  {{text = ' 𝙒𝙧 𝙎𝙞𝙧𝙞𝙖 𝙏𝙢',url="t.me/Ahmed_siria"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺',url="t.me/Ahmed_siria"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/siria22"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/Ahmed_siria"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
