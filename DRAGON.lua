...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\naٴ≪ـــــــــــــــــــــ𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31mٴ≪ـــــــــــــــــــــ𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪ـــــــــــــــــــــ𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪ـــــــــــــــــــــ𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.write('\27[0;31mٴ≪ـــــــــــــــــــــ𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua DRAGON.lua')
end 
end
