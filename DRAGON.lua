...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀  𝙎𝙞𝙧𝙞𝙖.',url="t.me/siria22"}},
}
local msg_id = msg.id_/2097152/0.5
...
*𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕*
➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪. ](t.me/siria22)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/siria22)') 
return false
end
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/siria22"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/siria99"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
