...
database:set(id_server..":username",data.result.username)
end 
else
...
user = database:get(bot_id..":username")
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧مـبرمج السـورس✧',url="t.me/Ahmed_siria"}},  
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..user..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
