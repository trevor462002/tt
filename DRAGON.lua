...
sudo_users = {SUDO,1840926402,1801776653,1898959449,1754365642,1828944841,1892231097}   
...
local UserName = (data.username_ or "ME_NO15")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اقمـد من القمـدن  ياروحـي.', url="t.me/siria99"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ME_NO15')..') \n✧︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"✧︙ العضو : {["..data.first_name_.."](T.ME/ME_NO15)}\n✧︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✧︙ عذرا » {["..data.first_name_.."](T.ME/ME_NO15)}\n✧︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭────── ● ☆ ● ──────────╮
☆
[  سَتجد هُنا اشخاص لم يتتجاوزو سـن العشـرين مِن عمرهم يحكون عن الخيبات والإنكسارات التي تَعرض لهم قلبهم بثمانية وعشرون حَرفًا فقط❤️  ](t.me/ME_NO15)

☆
╰────── ● ☆ ● ──────────╯
[  لـربمـا تـجـد مــآ تـشـعـر بـه هنـا 🌘❤️    ](t.me/ME_NO15)
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝙒𝙧 𝘼𝙢𝙤𝙧𝙮 ', url="https://t.me/Dv_69"},{text = '𝙒𝙧 𝘼𝙗𝙣 𝙀𝙡𝙨𝙖𝙝𝙚𝙡', url="https://t.me/ABN_ALSAHL2"}},  
  {{text = ' 𝙒𝙧 𝙎𝙞𝙧𝙞𝙖 𝙏𝙢',url="t.me/siria99"}},
{{text = '²₀³₁“ ꜱɪʀɪᴀ" ₉₀ | ₁₂.₀₀ ᴬᴹ', url="t.me/ME_NO15"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ME_NO15/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ME_NO15')..') \n✧︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ME_NO15')..') \n✧︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✧︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ME_NO15')..')'
status  = '\n✧︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✧︙ العضو » '..userid..''
...
{{text = ' مـبرمج السـورس ',url="t.me/siria99"}},  
}
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✧︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ME_NO15')..')'..'\n✧︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀  𝙎𝙞𝙧𝙞𝙖.',url="t.me/ME_NO15"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."ME_NO15:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✧ تم تفعيل الانستا')
database:set(bot_id.."ME_NO15:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ME_NO15:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ME_NO15:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ME_NO15:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ME_NO15:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ME_NO15')..')'
local iduser = result.sender_user_id_
...
*𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕*
➫ .[ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪. ](t.me/ME_NO15)➤
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/ME_NO15"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕
[✧ ????𝗨𝗥𝗖?? 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴  ✧](t.me/ME_NO15)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂✧](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ME_NO15)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/ME_NO15)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/siria99&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'حازم' or text == 'طافا' then  
local Text = [[  
𖤛اقمـد من القمـدان يروحي 𖤛
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𖤛صّآحًبً آلَتٌلَيَ يَقُلَبًمًکْ𖤛',url="t.me/T_A_F_A"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/T_A_F_A&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'حوريه' or text == 'حور' then  
local Text = [[  
✧قـلب داد 🥺❤️سوريا✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧حـوريـه✧',url="t.me/HOREYA3"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/HOREYA3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧انتـيكـآ ✧',url="t.me/Xx_Exefar_xX"}},  
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺',url="t.me/siria99"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'المكسيكي' or text == 'مكسيكي' then  
local Text = [[  
✧- الڪثيࢪ حاولو تقليدنا لڪن نبقئ الآصـل✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧الـمكـسيـكي ✧',url="t.me/M_IX_9"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/M_IX_9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بودا' or text == 'بودا ياه' then  
local Text = [[  
✧اقمـد من القمـدان يروحي ✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧بودا✧',url="t.me/L2llllllll"}},  
...
if text == 'هازيل' or text == 'هاذيل' then  
local Text = [[  
✧مـام هـاذيـل الطـيفه يقلبمك ✧
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧𝐇𝐀𝐙𝐄𝐋 ❤️.✧',url="t.me/MERAT_ELMAGIK"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MERAT_ELMAGIK&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/ME_NO15"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/siria99"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ME_NO15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
