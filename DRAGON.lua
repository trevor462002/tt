...
sudo_users = {SUDO,1726705278,1801776653,1836501705,1767369613,1792681561,1892231097}   
...
local UserName = (data.username_ or "ahmedabdalnaser2")
...
local Text = [[ 
[CH](t.me/ahmedabdalnaser2)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕', url="t.me/ahmedabdalnaser2"}}, 
} 
...
usertext = '\n✧︙ العضو » ['..result.title_..'](t.me/'..(username or 'ahmedabdalnaser2')..')'
status  = '\n✧︙ تم ترقيته مطور'
...
usertext = '\n✧︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ahmedabdalnaser2')..')'
status  = '\n✧︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ahmedabdalnaser2')..') \n✧︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"✧︙ العضو : {["..data.first_name_.."](T.ME/ahmedabdalnaser2)}\n✧︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "✧︙ عذرا » {["..data.first_name_.."](T.ME/ahmedabdalnaser2)}\n✧︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭──── ● ☆ ● ────╮
☆
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   ](t.me/ahmedabdalnaser2)
[𝒔𝒚𝒓𝒊𝒂 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆    ](t.me/ahmedabdalnaser2)
[𝒐𝒏 𝒕𝒆𝒍𝒆𝒆𝒈𝒓𝒂𝒎 ](t.me/ahmedabdalnaser2)
☆
╰──── ● ☆ ● ────╯
[⍟  𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/ahmedabdalnaser2)
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝙒𝙧 𝘼𝙢𝙤𝙧𝙮 ', url="https://t.me/Dv_69"},{text = '𝙒𝙧 𝘼𝙗𝙣 𝙀𝙡𝙨𝙖𝙝𝙚𝙡', url="https://t.me/ABN_ALSAHL2"}},  
  {{text = ' 𝙒𝙧 𝙎𝙞𝙧𝙞𝙖 𝙏𝙢',url="t.me/SIRIA199"}},
{{text = '²₀³₁“ ꜱɪʀɪᴀ" ₉₀ | ₁₂.₀₀ ᴬᴹ', url="t.me/ahmedabdalnaser2"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ahmedabdalnaser2/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ahmedabdalnaser2')..') \n✧︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✧︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ahmedabdalnaser2')..') \n✧︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\n𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕\n✧︙ علامة تعني { ✔️ } ملف مفعل\n✧︙ علامة تعني { ✖ } ملف معطل\n✧︙ قناة سورس سسوريا ↓\n".."✧︙ [اضغط هنا لدخول](t.me/ahmedabdalnaser2) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✧︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ahmedabdalnaser2')..')'
status  = '\n✧︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✧︙ العضو » '..userid..''
...
' }\n'..'✧︙  الايدي بالصوره » { '..idph..
' }\n'..'✧︙  الرفع » { '..setadd..
' }\n'..'✧︙  الحظر » { '..banm..' }\n\n𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕\n✧︙ قناة سورس سسوريا ↓\n [ ❍ ┇𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴   𓆪.](t.me/ahmedabdalnaser2) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✧︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ahmedabdalnaser2')..')'..'\n✧︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀.',url="t.me/ahmedabdalnaser2"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."ahmedabdalnaser2:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✧ تم تفعيل الانستا')
database:set(bot_id.."ahmedabdalnaser2:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ahmedabdalnaser2:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ahmedabdalnaser2:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ahmedabdalnaser2:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ahmedabdalnaser2:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ahmedabdalnaser2')..')'
local iduser = result.sender_user_id_
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
[✧ 𝗦𝗢𝗨𝗥𝗖𝗘  𖠱²² ✧](t.me/ahmedabdalnaser2)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/ahmedabdalnaser2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕
[✧ ????𝗨𝗥𝗖?? 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑰𝑹𝑰𝑨 𓏴  ✧](t.me/ahmedabdalnaser2)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
💥تحب هذا
𖠕━┅┅┄⟞❲🆂🅸🆁🅸🅰❳⟝┄┉┉━𖠕
[💥  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀💥 ](t.me/ahmedabdalnaser2)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂✧](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/ahmedabdalnaser2)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انـت عضو قمـيل 🥺❤️](t.me/ahmedabdalnaser2)') 
return false
end
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/ahmedabdalnaser2"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/SIRIA199"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ahmedabdalnaser2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
