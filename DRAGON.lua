...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '0000',url="https://t.me/source_Laren"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'بوت الحذف' or text == 'رابط الحذف' then  
local Text = [[  
╭──── ● ☆ ● ────╮
☆
بوت حذف حساب التليجرام فكر جيدا قبل ان تتسرع
☆
╰──── ● ☆ ● ────╯
⍟ 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𓆩 بوت حذف حساب التليجرام 𓆪',url="t.me/LC6BOT"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/LC50B&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𖤛حــازم𖤛',url="t.me/T_A_F_A"}},  
...
if text == 'aya' or text == 'ايه جمال' then  
local Text = [[  
𖤛 ستـك يـويو يروحي𖤛
]]  
keyboard = {}   
...
if text == 'تمارا' or text == 'tamara' then  
local Text = [[  
تـــمـــآرآ ❤️
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'تيمو',url="t.me/temo_0k"}},  
