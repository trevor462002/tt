...
╭──── ● ☆ ● ────╮
☆
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   ](t.me/SOURCE_SYRIA)
[𝒔𝒚𝒓𝒊𝒂 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆    ](t.me/SOURCE_SYRIA)
[𝒐𝒏 𝒕𝒆𝒍𝒆𝒆𝒈𝒓𝒂𝒎 ](t.me/SOURCE_SYRIA)
☆
╰──── ● ☆ ● ────╯
[⍟  𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/SOURCE_SYRIA)
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '𝙒𝙧 𝘼𝙢𝙤𝙧𝙮 ', url="https://t.me/Dv_69"},{text = '𝙒𝙧 𝘼𝙗𝙣 𝙀𝙡𝙨𝙖𝙝𝙚𝙡', url="https://t.me/ABN_ALSAHL2"}},  
  {{text = ' 𝙒𝙧 𝙎𝙞𝙧𝙞𝙖 𝙏𝙢',url="t.me/SIRIA199"}},
{{text = '²₀³₁“ ꜱɪʀɪᴀ" ₉₀ | ₁₂.₀₀ ᴬᴹ', url="t.me/SOURCE_SYRIA"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SOURCE_SYRIA/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
{{text = '✧قنـآة السـورس ✧', url="https://t.me/SOURCE_SYRIA"},{text = '✧مــبـرمج السورس ✧', url="https://t.me/SIRIA199"}}, 
}  
local msg_id = msg.id_/2097152/0.5  
